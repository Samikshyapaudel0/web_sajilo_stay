...
import { Bell, User, Search, MapPin, Calendar, Users, Star, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-bold text-center mb-6">
            Find your perfect stay<br />anywhere in Nepal
          </h1>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Popular Stays in Nepal</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {popularStays.map((stay) => (
              <div key={stay.id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <div className="relative">
                  <img
                    src={stay.image}
                    alt={stay.title}
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-gray-900 mb-1">{stay.title}</h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <p className="font-bold text-gray-900">
                      ${stay.price}<span className="text-sm font-normal text-gray-600">/night</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm">
                Your trusted partner for finding the perfect stay in Nepal. Experience the beauty of Nepal with comfort and ease.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><Link href="#" className="hover:text-white">Safety Information</Link></li>
                <li><Link href="#" className="hover:text-white">Cancellation Options</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="#" className="hover:text-white">Host Your Home</Link></li>
                <li><Link href="#" className="hover:text-white">Host an Experience</Link></li>
                <li><Link href="#" className="hover:text-white">Responsible Hosting</Link></li>
              </ul>
            </div>
          </div>
